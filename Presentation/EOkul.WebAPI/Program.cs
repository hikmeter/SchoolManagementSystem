...
builder.Services.AddValidatorsFromAssemblyContaining<CreateCourseAssignmentValidator>();
builder.Services.AddValidatorsFromAssemblyContaining<UpdateCourseAssignmentValidator>();
