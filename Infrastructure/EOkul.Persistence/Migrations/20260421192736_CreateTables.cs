        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExamId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CourseAssingmentId = table.Column<int>(type: "int", nullable: false),
                    CourseAssignmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_CourseAssignments_CourseAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Homeworks_CourseAssignments_CourseAssignmentId",
                        column: x => x.CourseAssignmentId,
                        principalTable: "CourseAssignments",
                        principalColumn: "CourseAssignmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_CourseAssignments_CourseAssignmentId",
                        column: x => x.CourseAssignmentId,
                        principalTable: "CourseAssignments",
                        principalColumn: "CourseAssignmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_CourseAssignments_CourseAssignmentId",
                        column: x => x.CourseAssignmentId,
                        principalTable: "CourseAssignments",
                        principalColumn: "CourseAssignmentId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_CourseAssignmentId",
                table: "Exams",
                column: "CourseAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Grades_CourseAssignmentId",
                table: "Grades",
                column: "CourseAssignmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homeworks_CourseAssignmentId",
                table: "Homeworks",
                column: "CourseAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_CourseAssignmentId",
                table: "Schedules",
                column: "CourseAssignmentId");
